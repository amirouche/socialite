...
latex_documents = [
    (master_doc, "socialiter.tex", "socialiter Documentation", "socialiter", "manual")
]
...
man_pages = [(master_doc, "socialiter", "socialite Documentation", [author], 1)]
